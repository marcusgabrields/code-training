...
Problem:
    ...
    Otherwise, the score of this word is . The score for the whole list 
    of words is the sum of scores of all words in the list.
    ...
    Output Format:
        ...
        function score_words with the list of words read from the input as the argument 
        and prints the returned score to the output.
    ...
    Explanation 0:
        ...
        because it contains an even number of vowels, i.e. 2 vowels, and the score of book is 2 + 2 = 4
        for the same reason. Thus the total score is .
    ...
    Explanation 1:
        There are  words in the input: programming, is and awesome. The score of programming 
        is 1 since it contains 3 vowels, an odd number of vowels. The score of is is also 1 because 
